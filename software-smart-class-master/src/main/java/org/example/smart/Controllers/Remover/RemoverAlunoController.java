...
public class RemoverAlunoController implements Initializable {
    ...
    @FXML private TreeTableView<Aluno> treeTableProfessores;
    ...
    @FXML private TreeTableColumn<Aluno, Integer> colID_ALUNO;
    ...
    private void loadAlunos() {
        try {
            ...
            treeTableProfessores.setColumnResizePolicy(TreeTableView.CONSTRAINED_RESIZE_POLICY);
    ...
    private void removerAluno() {
        TreeItem<Aluno> selectedItem = treeTableProfessores.getSelectionModel().getSelectedItem();
